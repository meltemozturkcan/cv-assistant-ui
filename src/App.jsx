...
function App() {
  ...
  // Overlay görünürlüğü için mobil kontrolüne gerek yok, isSidebarOpen mobilde CSS ile yönetilecek
  ...
  // Pencere boyutu değişince masaüstüne geçilirse menüyü kapat (state temizliği)
  useEffect(() => {
    const handleResize = () => {
  ...
  const sendMessage = async (e, questionText = null) => {
    ...
    setInput('')
    setIsSidebarOpen(false) // Mesaj gönderince menüyü kapat
    ...
    try {
      ...
      console.error(err) // Hata loglandı
      setMessages(prev => [
        ...prev,
        {
          role: 'assistant',
  ...
  return (
    <div className="app">
      {/* 
          SIDEBAR 
          Mobilde 'fixed' pozisyonda ve 'open' class'ı ile kontrol ediliyor.
          İçeriğin tamamı orijinal haline döndürüldü.
      */}
