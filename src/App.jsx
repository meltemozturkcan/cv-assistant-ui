...
function App() {
  ...
  // Masaüstüne geçilirse menüyü kapat
  useEffect(() => {
    const handleResize = () => {
  ...
  const sendMessage = async (e, questionText = null) => {
    ...
    setInput('')
    setIsSidebarOpen(false) // Mesaj gönderilince mobilde menü kapansın
  ...
  return (
    <div className="app">
      {/* SIDEBAR: Tüm içerikler orijinal haliyle eklendi */}
      <aside className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        <div className="sidebar-content">
          <div className="profile-section">
            ...
            <p className="bio">
              ...
              teknolojilerle ölçeklenebilir çözümler üreten full-stack geliştirici.
            </p>
          </div>
        ...
        <div className="sidebar-footer">
          <div className="social-links">
            <a href="https://www.linkedin.com/in/meltem-öztürkcan" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </a>
            <a href="https://github.com/meltemozturkcan" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
          ...
          <p className="copyright">
            © 2025 Meltem Öztürkcan<br />Designed with ❤️
          </p>
        </div>
      </aside>

      {/* OVERLAY: Sidebar açıkken arka planı karart */}
      <div 
      ...
      <main className="main-content">
        {/* MOBILE HEADER: Sidebar toggle butonu */}
        <div className="mobile-header">
          <button className="menu-btn" onClick={() => setIsSidebarOpen(true)}>☰</button>
          <div className="mobile-title">
            <img src={AVATAR_URL} alt="Meltem" className="mobile-avatar" />
            <span>Meltem AI</span>
          </div>
        </div>

        {/* Desktop Header */}
        <header className="chat-header hidden-mobile" style={{ display: window.innerWidth <= 900 ? 'none' : 'block' }}>
          <div className="header-info">
            <h1>Meltem AI - Özgeçmiş Asistanı</h1>
            <p>Meltem’in kariyeri, teknik uzmanlıkları ve projeleri hakkında sorularınızı yanıtlamaya hazırım.</p>
          </div>
        </header>
        ...
        <div className="bottom-questions">
          <p style={{fontSize: '0.8rem', color: '#666', marginBottom: '10px'}}>Hızlı Sorular:</p>
          <div className="quick-btns">
            {QUICK_QUESTIONS.map((q, i) => (
              <button key={i} onClick={() => sendMessage(null, q)} disabled={isLoading}>
                {q}
              </button>
            ))}
          </div>
        ...
        <div className="main-footer">
          <div className="footer-links">
            <a href="https://www.linkedin.com/in/meltem-öztürkcan" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            <span>•</span>
            <a href="https://github.com/meltemozturkcan" target="_blank" rel="noopener noreferrer">GitHub</a>
          </div>
