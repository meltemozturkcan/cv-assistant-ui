...
function App() {
  ...
  // Sidebar mobilde açık mı?
  const [isSidebarOpen, setIsSidebarOpen] = useState(false)

  // Ekran mobil mi? (sadece client’ta, ilk açılışta doğru gelsin)
  ...
  // Resize ile mobil/desktop durumunu güncelle
  useEffect(() => {
    const handleResize = () => {
      ...
      // Desktop’a geçince sidebar hep açık olsun (görünsün)
      if (!mobile) {
  ...
  const sendMessage = async (e, questionText = null) => {
    ...
    setInput('')
    // Mobilde bir soru sorduktan sonra menüyü kapat
    setIsSidebarOpen(false)
